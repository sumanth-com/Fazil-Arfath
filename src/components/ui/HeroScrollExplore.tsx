...
export function HeroScrollExplore({ href = ROUTES.about }: HeroScrollExploreProps) {
  ...
  return (
    <Link
      ...
      data-cursor="hover"
      className="fixed bottom-8 right-8 z-[100] flex h-12 w-12 items-center justify-center rounded-full border border-[#ff3b30]/50 bg-gradient-to-b from-[#1c1c1c] via-[#0a0a0a] to-[#140808] text-[#ff3b30] shadow-[0_8px_24px_rgba(0,0,0,0.55),0_0_20px_rgba(255,59,48,0.12)] transition-[border-color,box-shadow] duration-300 hover:border-[#ff3b30]/80 hover:shadow-[0_10px_28px_rgba(0,0,0,0.6),0_0_28px_rgba(255,59,48,0.22)] max-lg:bottom-6 max-lg:right-6 max-lg:h-11 max-lg:w-11"
      style={
        reducedMotion
          ? undefined
